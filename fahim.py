...
\033[1;37m------------------------------------------------
\033[1;37m Owner   :             FAHIM
\033[1;37m Facebook:            Fahim Ahamed
\033[1;37m Github  :            FAHIM-7777
...
def sarfraz():   
    ...
    if select =='1':
       ...
       cutter()
        ...
        os.system('xdg-open https://www.facebook.com/Fahim.Tera.Real.Papa.Hey?mibextisarfL')
    else:
        print('\n Select valid option ... ')
        time.sleep(2)
        SSB(allkey)
...
def cutter():
    ...
    print(logo)
    print("Removed Successful From File: " + ssb )
    print("New File Saved:" + fahim.txthttps://www.facebook.com/Fahim.Tera.Real.Papa.Hey?mibextid=ZbWKwL)
    print(47*'-')
